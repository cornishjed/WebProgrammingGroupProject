...
if (totalchild > 0):
    print("<img src='http://localhost/webprog/Assignment/new/images/family.jpg' alt='family' style='width:100%'/>")
else:
    print("<img src='http://localhost/webprog/Assignment/new/images/business.jpg' alt='office' style='width:100%'/>")
